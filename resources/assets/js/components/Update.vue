 ...
 <div class="modal" :class='openmodal'>
  ...
  <div class="modal-card">
	...
	<div class="field">
	  ...
	  <div class="control">
	    <input class="input" :class="{'is-danger':errors.phone}" type="text" v-model="list.phone" placeholder="Phone">
	  </div>
	...
	<div class="field">
	  ...
	  <div class="control">
	    <input class="input" :class="{'is-danger':errors.email}" type="text" v-model="list.email" placeholder="Email">
	  </div>
